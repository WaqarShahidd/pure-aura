          ...
          <div className="mx-auto flex max-w-7xl flex-col-reverse items-center justify-between gap-4 px-6 py-6 text-xs text-white/60 md:flex-row md:px-10">
            <div className="flex items-center gap-4">
              <button type="button" className="flex items-center gap-1 hover:text-white">
                {site.languages[0]} <KeyboardArrowDownIcon fontSize="inherit" />
              </button>
              <button type="button" className="flex items-center gap-1 hover:text-white">
                {site.regions[0]} <KeyboardArrowDownIcon fontSize="inherit" />
              </button>
            </div>
            ...
            <div className="flex items-center gap-2">
              {site.paymentIcons.map((label) => (
                <span
                  key={label}
                  className="rounded border border-white/20 px-2 py-1 text-[10px] uppercase tracking-wide"
                >
                  {label}
                </span>
              ))}
